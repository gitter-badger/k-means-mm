...
function choose_data(callback) {
    ...
    var n = 500; // number of points to populate

    var smiley_dat = function() { return smiley(n); };
    var unif_dat  = function() { n = 50; return uniform(n); };
    var threenorm_dat = function() { n= 30; return threenorm(n); };
    var pimples_dat = function() { return pimples(n); };
    var circles = function() { return circle_pack(n); };
    var density = function() { return density_bars(n); };
    var dbscan_dat = function() { return dbscan_all(); };
    var predefinedPoints_dat = function() { n= 30; return predefinedPoints(n); };    
    ...
    var choices = [
        ...
        {name: "Predined Points", choice: predefinedPoints_dat, txtpos_x: -14.0}        
    ];
